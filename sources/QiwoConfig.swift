...
final class QiwoConfig {
  ...
  func open(schemaID: String, baseConfig: QiwoConfig?) -> Bool {
    close()
  ...
  func getColor(_ option: String, inSpace colorSpace: QiwoTheme.RimeColorSpace) -> NSColor? {
...
private extension QiwoConfig {
  ...
  func color(from colorStr: String, inSpace colorSpace: QiwoTheme.RimeColorSpace) -> NSColor? {
  ...
  func color(alpha: Int, red: Int, green: Int, blue: Int, colorSpace: QiwoTheme.RimeColorSpace) -> NSColor {
    switch colorSpace {
    case .displayP3:
