...
**Full Changelog**: https://github.com/rime/qiwo/compare/1.1.1...1.1.2
...
**Full Changelog**: https://github.com/rime/qiwo/compare/1.1.0...1.1.1
...
**Full Changelog**: https://github.com/rime/qiwo/compare/1.0.3...1.1.0
...
**Full Changelog**: https://github.com/rime/qiwo/compare/1.0.2...1.0.3
...
* Logs dir is now $TMPDIR/rime.qiwo for clarity

**Full Changelog**: https://github.com/rime/qiwo/compare/1.0.1...1.0.2
...
#### Other Updates
* Bug fixes:
  * Remove Latn repertoire so that switching IME by Caps Lock can toggle Qiwo and Latin input
...
**Full Changelog**: https://github.com/rime/qiwo/compare/1.0.0...1.0.1
...
#### Major Update
* Migrated code to pure Swift, which is easier to code, read and learn. Build your own Qiwo today!
...
**Full Changelog**: https://github.com/rime/qiwo/compare/0.18...1.0.0
...
* Other UI improvements:
  * Resolve a issue that Qiwo panel shows in corner on first launch
...
#### 完整更新列表 Change Log
* build: specify build target OS in makefile by @LEOYoon-Tsaw in https://github.com/rime/qiwo/pull/727
* Consolidated update to Qiwo by @LEOYoon-Tsaw in https://github.com/rime/qiwo/pull/749
* Update INSTALL.md: Fix script by @EdgarDegas in https://github.com/rime/qiwo/pull/800
* fix action-changelog.sh by @hezhizhen in https://github.com/rime/qiwo/pull/794
* Update weasel introduction in README.md by @determ1ne in https://github.com/rime/qiwo/pull/777
* Upgrade GitHub action to v4 by @Bambooin in https://github.com/rime/qiwo/pull/834
* chore: use macos 14 runner with M1 by @Bambooin in https://github.com/rime/qiwo/pull/835
* Add mac app sandbox support. by @ShikiSuen in https://github.com/rime/qiwo/pull/841
* Apply clang format by @Bambooin in https://github.com/rime/qiwo/pull/836
* fix: fix wrong git blame ignore by @Bambooin in https://github.com/rime/qiwo/pull/845
* replace deprecated API calls by @groverlynn in https://github.com/rime/qiwo/pull/846
* fix(QiwoPanel): text shown in top-left corner by @lotem in https://github.com/rime/qiwo/pull/856
* deps: update librime to 1.11.0 by @ksqsf in https://github.com/rime/qiwo/pull/860
* build(ci): nightly release by @ksqsf in https://github.com/rime/qiwo/pull/861
* ci: disable nightly build in forked repos by @Bambooin in https://github.com/rime/qiwo/pull/862

#### 新增貢獻者 New Contributors
* @EdgarDegas made their first contribution in https://github.com/rime/qiwo/pull/800
* @hezhizhen made their first contribution in https://github.com/rime/qiwo/pull/794
* @determ1ne made their first contribution in https://github.com/rime/qiwo/pull/777
* @ksqsf made their first contribution in https://github.com/rime/qiwo/pull/860

**Full Changelog**: https://github.com/rime/qiwo/compare/0.16.2...0.18
 ...
 * 升級安裝後遇輸入法不可用，須手動重新添加 [#704](https://github.com/rime/qiwo/issues/704)
 ...
 * 修復：macOS Mojave 及以下版本單擊 Shift 等修飾鍵失效 [#715](https://github.com/rime/qiwo/issues/715)
 * 修復：全新安裝只添加一個輸入法選項（簡體中文） [#714](https://github.com/rime/qiwo/issues/714)


#### Bug Fixes

*   modifier change event in older macOS ([5c2b7e64](https://github.com/rime/qiwo/commit/5c2b7e64980b7e6b7eb3a8b392163ce89d244f37))
*   install one input mode or keep previous ones ([3bc6c2c0](https://github.com/rime/qiwo/commit/3bc6c2c0edbb1adaa22e79da65c6f0116b164de7))
 ...
 * 輸入狀態變化時顯示方案中設定的狀態名稱 [#540](https://github.com/rime/qiwo/pull/540)
 * 修正繪文字行高 [#559](https://github.com/rime/qiwo/issues/559)
 * 支持半透明視窗背景 [#589](https://github.com/rime/qiwo/pull/589)
 * 由 GitHub Actions執行自動構建 [#633](https://github.com/rime/qiwo/pull/633)
 * 將齐我输入法的輸入語言註冊爲簡體中文及繁體中文 [#648](https://github.com/rime/qiwo/pull/648)
 * 可指定使用任意一種系統鍵盤佈局 [#687](https://github.com/rime/qiwo/pull/687)
   例如： `qiwo.yaml:/keyboard_layout: USExtended`
 * 區分左、右修飾鍵 [#688](https://github.com/rime/qiwo/pull/688)
 * 支持以命令行方式同步用戶數據 [#694](https://github.com/rime/qiwo/pull/694)
   命令： `Qiwo --sync`
...
* 修復工單 [#513](https://github.com/rime/qiwo/issues/513)
* 重製應用圖標，提升暗色背景下的可見度

#### Bug Fixes

* **QiwoInputController:**  commit raw input when switching to other IME, closes #146 ([b875d194](https://github.com/rime/qiwo/commit/b875d194d9799ccc74453292c670fcca892799fa))
* **QiwoPanel:**  use of uninitialized local variable linear, vertical ([e8b87a4f](https://github.com/rime/qiwo/commit/e8b87a4f97994001c6889ecc1d43fa38e7589e66))

#### Features

* **QiwoIcon:**  updated app icon ([76d742b8](https://github.com/rime/qiwo/commit/76d742b8ee271c24dae5f98251a93930e57279ec))
...
* **QiwoPanel:**  decompose candidate_format when loading theme ([803f6421](https://github.com/rime/qiwo/commit/803f64218384b505cbea1289af85a2b65f8f83f5), closes [#516](https://github.com/rime/qiwo/issues/516))

#### Bug Fixes

*   avoid implicit lossy integer transform ([da4fcbf2](https://github.com/rime/qiwo/commit/da4fcbf2b77ca8298eaa8043937ee2c98f95ee0f))
* **QiwoPanel:**
  *  vertical glyph in comment text with smaller font ([c2e6f434](https://github.com/rime/qiwo/commit/c2e6f4347413a67278ab12eb388d5225e02e3fb1), closes [#522](https://github.com/rime/qiwo/issues/522))
  *  unspecified comment_font_point falls back to font_point ([8194d95a](https://github.com/rime/qiwo/commit/8194d95a82554c453f84ff4dd30eaa51affd10ae))
* **QiwoPanel.m:**  error with candidate_format without the label part ([d2b839b6](https://github.com/rime/qiwo/commit/d2b839b6b5c415aa1cdd28e1ef7921949b90ee21), closes [#516](https://github.com/rime/qiwo/issues/516))

#### Features

* **QiwoPanel:**  comment font config (#511) ([3d0ab6a2](https://github.com/rime/qiwo/commit/3d0ab6a209c31c0ac2b97bd8ab1bddcc269aa9bb))
...
* 界面新功能
  ...
  * 新增明暗兩款Solarized配色方案
    [`qiwo.yaml`](https://github.com/rime/qiwo/blob/master/data/qiwo.yaml)演示了P3色域、自選深淺系配色方案的用法

* 修復及規避若干軟件兼容問題

![有詩爲證](https://github.com/rime/home/raw/master/images/qiwo-vertical-text-light.png)
![有圖爲證](https://github.com/rime/home/raw/master/images/qiwo-vertical-text-dark.png)

#### Bug Fixes

* **QiwoInputController:**  add back the Chrome address bar hack ([22ed91ea](https://github.com/rime/qiwo/commit/22ed91ea7d2c9807dedc8cd68709c82cdb3a5fd8), closes [#299](https://github.com/rime/qiwo/issues/299))
* **QiwoPanel:**
  *  properties custom getter got wrong names ([d509c779](https://github.com/rime/qiwo/commit/d509c7791d288722a6782cca8c9afd7d0b440db5), closes [#494](https://github.com/rime/qiwo/issues/494))
  *  label format after candidate repeats label before, Closes #489 ([d2c34107](https://github.com/rime/qiwo/commit/d2c34107bdbec5767865582e4d217e546d576eca))
  *  native color scheme can only use semantic colors ([e6c69598](https://github.com/rime/qiwo/commit/e6c695983e610bd78d8c43b033a4c3602b632730))
  *  reimplement blendColors, tune background color fraction to increase contrast ([9b890f60](https://github.com/rime/qiwo/commit/9b890f60667c291216ff971b176534627f6a1cac))
* **QiwoPanel.m:**  index out of bounds at drawSmoothLines() ([241b457f](https://github.com/rime/qiwo/commit/241b457fc0378c733ead8cb9352c156c12198cec))
* **build:**
  *  exclude architecture arm64 ([51f62cf7](https://github.com/rime/qiwo/commit/51f62cf7e52d779f8721f2ffcf5fc2b6720155c3))
  *  fix codesign error on Xcode11 ([11486644](https://github.com/rime/qiwo/commit/1148664423ae1fc986df184ef2f794790cd31834))
* **data/qiwo.yaml:**
  *  force inline in Chrome to work around bksp ([69112996](https://github.com/rime/qiwo/commit/69112996441fdae1d1778ac9a32eb98f6a8e7841))
  *  force inline mode in Telegram app ([34f2d382](https://github.com/rime/qiwo/commit/34f2d38216a7483ed8634da5de8409f6a3d7f542))
* **qiwo.yaml:**  unset default value for style/candidate_list_layout to fall back style/horizontal ([a9af3364](https://github.com/rime/qiwo/commit/a9af33644ff6c5ab0b7ea90a2af6715f1113fd68))

#### Features

* **QiwoConfig:**  support display P3 color space ([8ff5f8d0](https://github.com/rime/qiwo/commit/8ff5f8d024c034f2217c67cf8dc77aa47a5a7b34))
* **QiwoInputController:**
  *  app option `inline` forces inline mode ([699fee0f](https://github.com/rime/qiwo/commit/699fee0fd2c9808667fd60426f1abc8c09d7ff8d))
  *  support chording with Control, Alt or Shift keys ([118aee61](https://github.com/rime/qiwo/commit/118aee617089b4c7a3e448a42ea0b4c65eae5895))
* **QiwoPanel:**
  *  optimize window size for big/small text ([150c5533](https://github.com/rime/qiwo/commit/150c5533f8862b242e1837fb0b62e97429cbb2a3))
  *  merge lyc/dark_mode, with slight modifications ([5a587fca](https://github.com/rime/qiwo/commit/5a587fca16d7b6c842682f285949041871ed80bf), closes [#449](https://github.com/rime/qiwo/issues/449))
* **app_options:**  support the `vim_mode` app option ([08ed4f45](https://github.com/rime/qiwo/commit/08ed4f4590e17c969f1536b347bbe1f05737d4aa), closes [#124](https://github.com/rime/qiwo/issues/124))
* **data/qiwo.yaml:**  solarized color schemes ([35b9ea76](https://github.com/rime/qiwo/commit/35b9ea76d2c3c4ce095bc838948ba43761022a12))
* **ui:**  vertical text orientation, rounded corner text with TextStorage, wrapping lone lines and border color ([c6c9302d](https://github.com/rime/qiwo/commit/c6c9302dcd537e0b72af729082390483bc3d07c0))
...
* **package/add_data_files:**  update xcode project to install all files under data/plum ([2ab1810e](https://github.com/rime/qiwo/commit/2ab1810e94b963df27e6fd2e399465ccdabba138))
* **travis-ci:**  fetch latest rime binaries in install script, install extra recipes ([027679d5](https://github.com/rime/qiwo/commit/027679d58974845a83a393a313bbd63462a795b1))
...
* 安裝預設輸入方案集，避免大多數方案依賴問題 [#279](https://github.com/rime/qiwo/issues/279)

#### Features

* **plum:**  bundle preset recipes ([7885c5fa](https://github.com/rime/qiwo/commit/7885c5fa6006e999c5a07ac1800e9afa15d629a8))
...
* **qiwo.yaml:**  duplicate YAML key in color scheme dust ([44a4d7ee](https://github.com/rime/qiwo/commit/44a4d7ee3cad94c170616b7c8d9415a4f92c86d5))

#### Features

* **qiwo.yaml:**  udpate UI settings ([d8b1dc56](https://github.com/rime/qiwo/commit/d8b1dc569cc2c168f0fc5e8240ff6e049142fc24))
* **travis-ci:**  deploy release package ([c367b675](https://github.com/rime/qiwo/commit/c367b675bbca4f7e4467b71b9f42adbb888b77a5))
...
* **librime:**  update to librime 1.4.0 ([1f07c63c](https://github.com/rime/qiwo/commit/1f07c63c51f60ea5514819c0f3a05c33ee9aba5d))
* **pkg:**  logout after install ([c84001ea](https://github.com/rime/qiwo/commit/c84001ea4348b902543938d89d68306b1ea86b3f))
* **travis-ci:**  add Travis CI automated build ([8855101c](https://github.com/rime/qiwo/commit/8855101c0d90c118d4d1d58b757d11d76354bcda))

#### Bug Fixes

* **app:**  opt out of dark mode ([083817cb](https://github.com/rime/qiwo/commit/083817cba5ccb1f5b9589b7e7a2fbeca4ec4d9dd), closes [#273](https://github.com/rime/qiwo/issues/273))
...
* **QiwoPanel:**  add mojave_dark theme and hilited_corner_radius option ([51a1c8c8](https://github.com/rime/qiwo/commit/51a1c8c840cfc9093ad56777873c8a62abc4964f))
* **app icon:**  update app icon ([593ca16e](https://github.com/rime/qiwo/commit/593ca16ebc87852213348b55d1072d898af75ab6))
* **brise:**  new preset configuration; disable prebuilding binary data during install ([43f4eb0a](https://github.com/rime/qiwo/commit/43f4eb0a0f1551f385f517a24ba30ac364af2a8c))
* **chord:**  Tab, BackSpace, Return can be used as chording keys ([997f1539](https://github.com/rime/qiwo/commit/997f15396615de4a3f65e5595ce1f5edf75263a1))
* **data/qiwo.yaml:**  add two more color schemes ([48b5138c](https://github.com/rime/qiwo/commit/48b5138c53d30e433a5c4de95c7a366e51f94e2e))
* **install:**  preload minimal rime data, fetch packages in postinstall script ([d2b174c9](https://github.com/rime/qiwo/commit/d2b174c9bbb263f1cf0953ddb4a607e68525e396))
* **package:**  make package && make archive ([c350c086](https://github.com/rime/qiwo/commit/c350c086d7321157c955275bbc4cec02a7f9b9eb))
* **qiwo.yaml:**
  *  add color schemes `purity_of_essence`, `apathy`, `dust` ([246a5797](https://github.com/rime/qiwo/commit/246a5797c49bd941fff80523523935dcf3c9a14d))
  *  ascii mode by default in hyper.is ([bda9f48e](https://github.com/rime/qiwo/commit/bda9f48e9c49f2514b885e31cceca579204506c3))
* **submodules:**  switch to /plum/ ([56e62287](https://github.com/rime/qiwo/commit/56e62287004b3f4579c966ed654d92e1dfc51f5e))

#### Bug Fixes

* **QiwoPanel:**
  *  highlight overlapping between adjacent candidates ([128c8f31](https://github.com/rime/qiwo/commit/128c8f310e70112282d445aa3716774850fc846c))
  *  fix rounding errors and highlight rounding corners correctly ([026c6980](https://github.com/rime/qiwo/commit/026c6980b5b5899c2f0b2be2c61d315cc49552c9), closes [#240](https://github.com/rime/qiwo/issues/240))
  *  display panel on top level in the proper way ([cee5c5d7](https://github.com/rime/qiwo/commit/cee5c5d70e523f4ab6c336dfd8941f7d7a7d3c35))
* **chord input:**  unfinished chord often caused by fast tap typing ([672af6c9](https://github.com/rime/qiwo/commit/672af6c972fcb99e532b171488ef0a4a3f06e985))
* **postinstall:**
  *  Revert "fix(postinstall): run rime-install preset packages" ([f0a2f45b](https://github.com/rime/qiwo/commit/f0a2f45bba81cafb5a67df09d4392750a38f0483), closes [#262](https://github.com/rime/qiwo/issues/262))
  *  run rime-install preset packages ([de8f32a2](https://github.com/rime/qiwo/commit/de8f32a2c00c4fac4cd0a23b80722e3129477086))
  *  run `Qiwo --install` as login user; do not update packages during installation ([66948afe](https://github.com/rime/qiwo/commit/66948afe6c50ef1a72a55abd505d2c8ceae4fe37))



<a name="0.9.26.2"></a>
## 齐我输入法 0.9.26.2 (2014-12-23)

  * 修復：安裝後輸入法在一些 app 中無法啓用 [#43](https://github.com/lotem/qiwo/issues/43)

<a name="0.9.26.1"></a>
## 齐我输入法 0.9.26.1 (2014-12-22)

  * 修復：0.9.26 版本設置 `translator/enable_user_dict: false` 發生崩潰

<a name="0.9.26"></a>
## 齐我输入法 0.9.26 (2014-12-16)
...
<a name="0.9.22"></a>
## 齐我输入法 0.9.22 (2013-11-09)

#### 【齐我输入法】變更集

  * 變更：不再支持 OS X 10.6，因切換到 libc++
  * 修復：安裝後重新登錄系統，齐我输入法從輸入法列表中消失的BUG
...
<a name="0.9.21.1"></a>
## 齐我输入法 0.9.21.1 (2013-10-09)

  * 修復：從上一個版本升級【倉頡】輸入方案不會自動更新的問題

<a name="0.9.21"></a>
## 齐我输入法 0.9.21 (2013-10-06)
...
<a name="0.9.20.4"></a>
## 齐我输入法 0.9.20.4 (2013-07-25)

  * 修復：原生配色方案候選序號顏色不正確

<a name="0.9.20.3"></a>
## 齐我输入法 0.9.20.3 (2013-07-24)
...
<a name="0.9.14.5"></a>
## 齐我输入法 0.9.14.5 (2013-01-10)

  * 新增：接收外部應用請求重新部署的通知，及命令行選項 Qiwo --reload
  * 修復：從 0.9.11 及更早的版本升級用戶詞典出錯</br>
    如果因此丟失詞彙，手動恢復的方法是：執行「同步用戶資料」

<a name="0.9.14"></a>
## 齐我输入法 0.9.14 (2013-01-07)
  ...
  * 修復：【地球拼音】不能以 - 鍵輸入第一聲
  * 新增：設定候選字及序號格式的選項 `qiwo.yaml`: `style/candidate_format:`

<a name="0.9.13"></a>
## 齐我输入法 0.9.13 (2012-12-26)
...
<a name="0.9.12"></a>
## 齐我输入法 0.9.12 (2012-12-23)

  * 新增：切換模式、輸入方案時彈出氣泡提示（安裝 Growl 效果最佳）
  * 新增：配色方案「Google」
  * 修復BUG：首次使用用戶目錄缺少 `qiwo.yaml`，部署之後才出現
...
## 齐我输入法 0.9.6 (2012-06-0x)
  ...
  * 較少用的【筆順五碼】、【速記打字法】不再隨齐我输入法發行
  * 修改BUG：簡拼 zhzh 因切分歧義使部分用戶詞失效

<a name="0.9.5"></a>
## 齐我输入法 0.9.5 (2012-05-06)
