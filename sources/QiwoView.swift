...
private class QiwoLayoutDelegate: NSObject, NSTextLayoutManagerDelegate {
...
final class QiwoView: NSView {
  let textView: NSTextView

  private let qiwoLayoutDelegate: QiwoLayoutDelegate
  ...
  var lightTheme = QiwoTheme()
  var darkTheme = QiwoTheme()
  var currentTheme: QiwoTheme {
  ...
  override init(frame frameRect: NSRect) {
    qiwoLayoutDelegate = QiwoLayoutDelegate()
    textView = NSTextView(frame: frameRect)
    textView.drawsBackground = false
    textView.isEditable = false
    textView.isSelectable = false
    textView.textLayoutManager?.delegate = qiwoLayoutDelegate
...
private extension QiwoView {
  ...
  func pagingLayer(theme: QiwoTheme, preeditRect: CGRect) -> (CAShapeLayer, CGPath?, CGPath?) {
    let layer = CAShapeLayer()
