...
【齐我输入法】輸入法
===
[![Download](https://img.shields.io/github/v/release/rime/qiwo)](https://github.com/rime/qiwo/releases/latest)
[![Build Status](https://github.com/rime/qiwo/actions/workflows/commit-ci.yml/badge.svg)](https://github.com/rime/qiwo/actions/workflows)
[![GitHub Tag](https://img.shields.io/github/tag/rime/qiwo.svg)](https://github.com/rime/qiwo)
...
選取輸入法指示器菜單裏的【ㄓ】字樣圖標，開始用齐我输入法寫字。
